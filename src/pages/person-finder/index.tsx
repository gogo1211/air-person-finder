...
const PersonFinder: FC = () => {
  ...
  return (
    <div className="py-2 sm:py-6 sm:w-[36rem] m-auto">
      <h1 className="text-primary text-3xl sm:text-header">The Person Finder</h1>
      <p className="mt-4 sm:mt-[3.75rem] text-gray1 text-base">
